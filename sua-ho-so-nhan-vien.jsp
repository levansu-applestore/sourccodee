        ...
        <section id="container" class="">
            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <section id="main-content" style="padding-top: 39px;">
                    ...
                    <%Personal2 p2=new Personal2();%>
                    <%PersonalDAO dao=new PersonalDAO();%>
                    <c:forEach var="p" items='<%=dao.getListP(Integer.parseInt(request.getParameter("Employee_ID")))%>'>
                    ...
                    <div>
                        ...
                        <div>
                            <input style="margin-left: 417px; color: #1aff1a" type="submit" value="Sửa Lại" />
