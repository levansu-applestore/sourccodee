...
<body
	...
	<section id="container" class="">
		...
		<section id="main-content" style="padding-top: 39px;">
			...
			<div>
				<a href="#"><i class="far fa-address-card">
						Quản Lý Kỷ Niệm Vào Làm</i></a> <span id="Searchhhh"><a href=""><i
						style="opacity: 0.7;" class="fas fa-search"></i></a><input
					style="color: red; opacity: 0.7; width: 257px; border-radius: 14px; background-color: rgba(0, 0, 0, 0); margin-top: 11px;; position: absolute;"
			...
			<div>
				<table id="bang">
					<tr>
						...
						<th>Email</th>
						<th>Ngày Bắt Đầu</th>
						<th>Kỷ Niệm Ngày Làm Đầu Tiên?</th>
					</tr>
							...
							<%
								int count = 0;
									for (NhanVienChinhThuc nv : PersonalDAO.getNhanVienChinhThuc()) {
										...
										String startDate = nv.getHire_Date();
										String endDate = simpleDateFormat.format(currentDate);

										Date date1 = simpleDateFormat.parse(startDate);
										Date date2 = simpleDateFormat.parse(endDate);

										Long getDiff = Math.abs((date1.getTime() - date2.getTime())) / (24 * 60 * 60 * 1000);
										count++;
										if(getDiff <=7){
