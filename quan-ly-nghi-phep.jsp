		...
		<section id="main-content" style="padding-top: 39px;">
			...
			<div>
				<i style="line-height: 51px; margin-left: 327px;"
					class="fas fa-calendar-times fa-3x"> Quản Lý Nghỉ Phép</i> <span
					id="Searchhhh"><a href=""><i
			...
			<div>
				<table id="bang">
					...
					<c:forEach var="e" items="<%=dao.getAllDay_off()%>" varStatus="temp">
						<tr>
							<td>${temp.count}</td>
							...
							<td>${e.getReason()}</td>
							<td>${e.getDate_Back()}</td>
							<td><form action="XuLyNgayNghi" method="GET">
									<i class="fas fa-wrench">Sửa Ngày Nghỉ</i>
									 <input type="text"name="ngaynghi" required placeholder="Nhập Số"> 
