                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li>
                                <a href="#"><i class="icon_mail_alt"></i> Contact Email</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="XuLyDangXuat"><i class="fas fa-sign-out-alt"></i> Exit</a>
                            </li>
                            <li>
                                <a href="https://www.facebook.com/levansu.suppor.it"><i class="fab fa-facebook-square"></i> Contact facebook</a>
                            </li>
                            <li>
