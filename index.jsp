    ...
    <body>
        ...
        <div class="header-w3l">
            ...
            <% String err = (String) request.getAttribute("error");
                if (err != null) {%>
            <div>
                <p style="color:red; font-size: 25px"><span style="margin-left:270px;"><%out.print(err); %></span></p>
            </div> 
            <% }%>
            <% User add = (User) request.getAttribute("add");
                if (add != null) {%>
            <div>
                <p style="color:red; font-size: 25px"><span style="margin-left:270px;">Đã Đăng Ký Tài Khoản,<%=add.getUsername()%></span></p>
            </div> 
            <% }%>
             <% String reset = (String) request.getAttribute("reset");
                if (reset != null) {%>
            <div>
                <p style="color:red; font-size: 25px"><span style="margin-left:270px;"><%out.print(reset); %></span></p>
            </div> 
            <% }%>
            ...
            <div class="wthree-form">
                ...
                <form name="hide_form" action="XuLyDangNhap" method="get">
                    ...
                    <label class="anim">
                        ...
                        <a href="fogot-password.jsp">Quên Mật Khẩu</a>
                    </label> 
                    <div class="clear"></div>
