<%@page import="model.Salary_Employee"%>
	...
	<section id="container" class="">
		...
		<section id="main-content" style="padding-top: 39px;">
			...
			<div style="text-align: center;">
				<i class="fas fa-donate fa-3x"> Quản Lý Lương</i> <span
					id="Searchhhh"><a href=""><i style="opacity: 0.7;"
						class="fas fa-search"></i></a><input
					style="color: red; opacity: 0.7; width: 257px; border-radius: 14px; background-color: rgba(0, 0, 0, 0.34);"
			...
			<div>
				<table id="bang">
					...
					<tr>
						<td><%=count%></td>
						<td><%=sa.getFirst_Name() + sa.getLast_Name()%></td>
						<td><%=sa.getPhone_Number() %></td>
						...
						%>
						<td><%=sa.getBirthday() %></td>
						<td><%=sa.getOvertime() %> ngày</td>
						<td><%=getLuongct%> vnđ</td>
						<%
							}
						%>
					</tr>
